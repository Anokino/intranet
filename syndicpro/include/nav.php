    ...
    <header>
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="index_pro.php">Intranet - Hôtel Rabanov</a>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="copro.php">Liste des copropriétaires</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="calc_fonds.php">Calcul appels de fond</a></li>
                            </ul>
                        </li>
                    </ul>
                    <div class="dropdown">
