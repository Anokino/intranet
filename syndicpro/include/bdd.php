...
{
   $req = "SET FOREIGN_KEY_CHECKS = 0; INSERT INTO `devis` (`iddevis`, `datedev`, `montantttc`, `idtravaux`, `idprestataire`, `idcopropriete`) VALUES (NULL, '$date', '$montant', '$travaux', '$presta', '$copro')";
   $res = $bdd->query($req);
   return $res;
};